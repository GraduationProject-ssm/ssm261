...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=59)
...
|chengse|varchar(200)|是|NULL|成色|
|shuliang|int(11)|是|NULL|数量|
|yuanjia|int(11)|是|NULL|原价|
|ershoujia|int(11)|是|NULL|二手价|
...
|guige|varchar(200)|是|NULL|规格|
|shangpinxiangqing|longtext|是|NULL|商品详情|
|qiugoushuliang|int(11)|是|NULL|求购数量|
|yugujiage|int(11)|是|NULL|预估价格|
|zhanghao|varchar(200)|是|NULL|账号|
|xingming|varchar(200)|是|NULL|姓名|
|shouji|varchar(200)|是|NULL|手机|
|sfsh|varchar(200)|是|否|是否审核|
...
|chengse|varchar(200)|是|NULL|成色|
|shuliang|int(11)|是|NULL|数量|
|ershoujia|varchar(200)|是|NULL|二手价|
|zongjia|varchar(200)|是|NULL|总价|
|maijiazhanghao|varchar(200)|是|NULL|卖家账号|
|maijiaxingming|varchar(200)|是|NULL|卖家姓名|
|jiaoyifangshi|varchar(200)|是|NULL|交易方式|
